// import { apiMarvel } from "../data/marvel.js";
const apiMarvel = [
    {
        "id": 1,
...
function pintarPeliculas(peliculas) {
    ...
    data.forEach(peli => {
        ...
        cajaPeli.innerHTML += `
            <div class="p-2 bd-highlight over" onclick="verVideo(${id})"><img class="cover" src="${img}" alt=""></div>
            `
    });
    // <div class="p-2 bd-highlight over" onclick="verVideo(${id})"><img class="cover" src="${img}" alt=""></div>
}
...
function verVideo(id){
    ...
    console.log(data2)
    data2.forEach(peli2 => {
        const { id, img, name, year, duration, resumen, actors, directors } = peli2;
        const cajaPeli = document.getElementById('cajaPeli2');
        cajaPeli.innerHTML += `
            <div class="p-2 bd-highlight over" onclick="verVideo(${id})"><img class="cover" src="${img}" alt=""></div>
            `
    });
