...
window.addEventListener('DOMContentLoaded', async()=> {
    ...
    <div class="card border-0 bg-black marginUp text-white">
        <img src="${img}" class="imgGrande card-img-top" alt="...">
    </div>
    ...
    <ul class="nav flex-column">
        ...
        <div class="container-fluid">
            <div class="d-grid gap-2">
                <button class="btn btn-light text-black" onclick="play()"><i class="fa-solid fa-play" ></i> Reproducir</button>
    ...
    <div class="">
        <ul class="share list-group list-group-horizontal text-center">
            <li class="list-group-item bg-transparent align-items-center">
                <i class="fa-solid fa-plus" onclick="lista(${id})"></i>
                <a class="nav-link text-secondary" href="#">Lista</a>
            </li>
            <li class="list-group-item bg-transparent">
                <i class="fas fa-thumbs-up"></i>
                <a class="nav-link text-secondary" href="#">calificar</a>
            </li>
            <li class="list-group-item bg-transparent">
                <i class="fas fa-share"></i>
                <a class="nav-link text-secondary" href="#">compartir</a>
            </li>
...
const form1 = document.getElementById('form2')
    ...
    form1.addEventListener('submit', (e) => {
        ...
        //realizo la busqueda
        const busqueda = apiMarvel2.filter(peli => peli.name.toLocaleLowerCase().includes(search.toLocaleLowerCase()));
        //llamo a la funcion a las tarjetas con el filtro
        pintarPeliculas(busqueda)
